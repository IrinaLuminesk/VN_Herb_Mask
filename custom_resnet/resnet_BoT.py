...
from attention_module.BoTNet_Model import resnet50 as resnet50_bot
...
class Resnet50_BoT(nn.Module):
    ...
    def build_layers(self):
            ...
            #Load state dict vào các layer gốc của resnet 
            pretrained_layer4 = backbone_model.layer4.state_dict()
            #Thay thế layer 4 bằng layer 4 của BoT
            backbone_model.layer4 = resnet_BoT.layer4
            missing, unexpected = backbone_model.layer4.load_state_dict(
                  pretrained_layer4,
