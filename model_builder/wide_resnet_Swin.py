...
from torchvision.models import wide_resnet50_2, Wide_ResNet50_2_Weights, swin_v2_b, Swin_V2_B_Weights
import torch
...
class Wider_Resnet50_Swin_BAM(nn.Module):
    def __init__(self, num_classes):
        super().__init__()
        self.num_classes = num_classes
        self.build_layers()
    def build_layers(self):
            wider_resnet_weights = Wide_ResNet50_2_Weights.DEFAULT
            backbone_model = wide_resnet50_2(weights=wider_resnet_weights)
...
class Wider_Resnet50_Swin(nn.Module):
    def __init__(self, num_classes):
        super().__init__()
        self.num_classes = num_classes
        self.build_layers()
    def build_layers(self):
            resnet_weights = Wide_ResNet50_2_Weights.DEFAULT
            backbone_model = wide_resnet50_2(weights=resnet_weights)
